...
High-fidelity helpers that complement the client-side web converter at https://alphaeusng.github.io/kobo-forge.html
...
```bash
# Basic
python koboforge-companion.py report.pdf --output report.epub

# With Kobo preset + metadata
python koboforge-companion.py financials.pdf \
  --preset libra \
