...
- `pages/`: secondary public pages.
  ...
  - `pages/kobo-forge.html`: compatibility redirect to the standalone
    [KoboForge](https://github.com/AlphaeusNg/KoboForge) project.
...
- Keep KoboForge implementation work in `/home/alph/projects/KoboForge`; this
  portfolio owns links and the legacy redirect only.
