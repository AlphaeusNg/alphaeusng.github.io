...
6. Market data is an end-of-day reference. A visible manual price override is
   the supported path for an intraday calculation.
...
The page reports the exact latest session, generation time, and staleness. It
