...
- `pages/kobo-forge.html`: compatibility redirect to the standalone KoboForge
  project at `/home/alph/projects/KoboForge`.
- KoboForge application code, styles, tests, and deployment now live entirely
  in `https://github.com/AlphaeusNg/KoboForge`.
